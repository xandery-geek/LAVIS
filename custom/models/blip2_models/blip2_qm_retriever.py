...
class Blip2QMRetriever(Blip2Base):
    ...
    def forward(self, samples):
        ...
        multimodal_feats = F.normalize(multimodal_feats.mean(dim=1), dim=-1) # [batch_size*2, embed_dim]

        query_feats = multimodal_feats[:bs] # [batch_size, embed_dim]
        evidence_feats = multimodal_feats[bs:] # [batch_size, embed_dim]
